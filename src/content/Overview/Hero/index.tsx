      ...
      >
        <Grid item md={10} lg={8} mx="auto">
          ...
          <TypographyH1 sx={{ mb: 2 }} variant="h1">
            You want to become frontend developer or blockchain developer
          </TypographyH1>
          <TypographyH2
            ...
            fontWeight="normal"
          >
           Become frontend developer by mastering HTML,CSS and Javascript with personalized AI mentor, take assessments, quizzes and interview preparation
          </TypographyH2>
          <Button
            component={Link}
